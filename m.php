...
<html>
<head>
    <script async src="https://analytics.umami.is/script.js" data-website-id="3f1feeff-e481-4961-8406-aee204c2b306"></script>
    <meta charset="utf-8">
...
<div class="web_notice" style="position: fixed;top: 0;left: 20%;width: 50%;height: 30%;background: rgba(0,0,0,0.3);z-index: 99999;">
    <div style="position: fixed;top: 50%;left: 50%;width: 300px;background: #FFF;transform: translate(-50%, -50%);border-radius: 40px;padding: 50px 40px;">
        <h3 style="font-weight: bold;text-align: center;font-size: 30px;">飞行鸽音乐🎵平台</h3>
        <img src="https://s1.ax1x.com/2023/07/16/pCIMfMt.png" alt="飞行鸽音乐图片" style="width: 200px; height: auto;">
        <div style="font-size: 16px;margin-top: 26px;line-height: 30px;color: #999;">一切都是为了更好的服务您<a href=""><b>飞行鸽🎵音乐</b></a></div>
        <a style="display: block;background: #98a3ff;color: #FFF;text-align: center;font-weight: bold;font-size: 19px;line-height: 60px;margin: 0 auto;margin-top: 45px;border-radius: 32px;width: 50%;" onclick="javascript:document.querySelector('.web_notice').remove()">我知道了</a>
    </div>
</div>
